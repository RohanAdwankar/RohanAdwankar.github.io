# Monitoring the 1B Frontier

This is my running notepad on what is possible with 1B parameter LLMs (or more accurately SLMs).
...
I'll keep this file updated with my attempts.
...
As it stands currently it's good at oneshotting simple algorithms, but not good at using the agentic tools provided to it.
