...
Files under `static/` are copied into `dist/` as they are. `static/semfont/` is a copy of the [semfont](https://github.com/RohanAdwankar/semfont) live page and engine, served at `/semfont/` and used by the semfont post.
