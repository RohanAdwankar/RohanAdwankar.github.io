  ...
  pins: [
    {
      ...
      scene: {
        ...
        camera: { pos: [6.5, 4.2, 8.5], look: [0, 1.1, 0] },
        props: [
        ...
        figures: [
          { id: 'trotsky', model: 'male-d', hair: '#1a1a1a', name: 'Leon Trotsky', at: [-2, 0.8], face: 0, pose: 'sit', coat: '#2e2e34', hair: '#2a2016', glasses: true, moustache: true, beard: '#2a2016',
          ...
          { id: 'altenberg', model: 'male-b', beard: '#b8b0a0', name: 'Peter Altenberg', at: [3.5, -1.4], face: 180, pose: 'sit', coat: '#8a7a66', hair: 'none', bald: true, moustache: true, skin: '#e8c8a8',
          ...
          { id: 'adler', model: 'male-f', hair: '#2a2016', name: 'Alfred Adler', at: [-4.5, -2.2], face: 0, pose: 'sit', coat: '#3a3f4a', vest: '#6a6a5a', moustache: true, glasses: true,
          ...
          { id: 'waiter', model: 'male-d', hair: '#2a2016', moustache: true, pose: 'hold', name: 'The Herr Ober', at: [0.5, 1.2], face: 200, coat: '#151515', vest: '#f4f0e6', held: 'paper',
    ...
    },
    {
      ...
      scene: {
        ...
        figures: [
          { id: 'freud', model: 'male-b', name: 'Sigmund Freud', at: [-2.6, -1.5], face: 90, pose: 'sit', coat: '#3a3a3a', vest: '#5a5a5a', hair: '#8a8a8a', beard: '#8a8a8a', glasses: true, skin: '#ddb090',
          ...
          { id: 'patient', model: 'female-b', dress: '#6a5a7a', name: 'A patient', at: [-0.3, -1.4], face: 60, pose: 'sit', coat: '#6a5a7a', hair: '#3a2a1a',
          ...
          { id: 'anna', model: 'female-f', dress: '#8a6a5a', name: 'Anna Freud', at: [2.0, -1.9], face: 180, pose: 'sit', coat: '#8a6a5a', hair: '#3a2a1a', held: 'paper',
    ...
    },
    {
      ...
      scene: {
        ...
        figures: [
          { id: 'schoenberg', model: 'male-f', pose: 'hold', name: 'Arnold Schoenberg', at: [0, -3.2], face: 180, coat: '#1a1a1a', vest: '#f4f0e6', hair: 'none', bald: true, held: 'baton',
          ...
          { id: 'berg', model: 'male-d', name: 'Alban Berg', at: [-5.0, 2.6], face: 60, coat: '#2a2a30', hair: '#2a2016',
          ...
          { id: 'webern', model: 'male-e', name: 'Anton Webern', at: [-5.8, 0.4], face: 90, coat: '#2a2a30', glasses: true, hair: '#4a3a2a',
          ...
          { id: 'buschbeck', model: 'male-d', hair: '#2a2016', pose: 'both', name: 'Erhard Buschbeck', at: [0, 3.6], face: 180, coat: '#3a3a44',
          ...
          { id: 'heckler', model: 'male-f', hair: '#2a2016', pose: 'both', name: 'A heckler', at: [1.2, 3.8], face: 200, coat: '#5a4a3a', hat: 'bowler', moustache: true,
    ...
    },
    {
      ...
      scene: {
        ...
        camera: { pos: [5, 3.6, 6.5], look: [-0.5, 1.2, -1] },
        props: [
        ...
        figures: [
          { id: 'franzjoseph', model: 'male-f', pose: 'both', bald: true, name: 'Franz Joseph I', at: [-1.5, -1.6], face: 200, coat: '#3a5a8a', vest: '#f4f0e6', hair: '#d8d8d8', bald: true, beard: '#d8d8d8', moustache: true, skin: '#e8c0a0', held: 'paper',
          ...
          { id: 'adjutant', model: 'male-d', hair: '#2a2016', name: 'Adjutant on duty', at: [2.5, 1.0], face: 300, coat: '#2e4a2e', hat: 'military', moustache: true,
    ...
    },
    {
      ...
      scene: {
        ...
        props: [
          ...
          { type: 'armchair', at: [-3.2, 0.8], rot: 90 }, { type: 'armchair', at: [3.0, 1.2], rot: 320 },
          { type: 'chandelier', at: [0, 0.5] },
          { type: 'cabinet', at: [-5.0, 1.5], rot: 90 },
        ],
        figures: [
          { id: 'franzferdinand', model: 'male-f', name: 'Archduke Franz Ferdinand', at: [0, -1.7], face: 180, pose: 'sit', coat: '#2e4a2e', vest: '#c8a860', moustache: true, hair: '#4a3a2a', skin: '#e0b898',
          ...
          { id: 'sophie', model: 'female-c', dress: '#7a4a6a', name: 'Sophie, Duchess of Hohenberg', at: [3.0, 1.2], face: 320, pose: 'sit', coat: '#7a4a6a', hair: '#3a2a1a', shawl: '#c8b8d8',
          ...
          { id: 'brosch', model: 'male-d', hair: '#2a2016', pose: 'hold', name: 'Major Brosch', at: [-2.4, -2.6], face: 120, coat: '#2e4a2e', hat: 'military', moustache: true, held: 'paper',
    ...
    },
    {
      ...
      scene: {
        ...
        figures: [
          { id: 'stalin', model: 'male-f', name: 'Joseph Stalin', at: [-1.6, -1.2], face: 180, pose: 'sit', coat: '#3a3a3a', hair: '#1a1a1a', moustache: true, skin: '#d8a888',
          ...
          { id: 'bukharin', model: 'male-e', name: 'Nikolai Bukharin', at: [1.0, -0.6], face: 250, pose: 'sit', coat: '#4a4a5a', hair: '#8a5a2a', beard: '#8a5a2a', glasses: true,
          ...
          { id: 'troyanovsky', model: 'male-d', hair: '#2a2016', name: 'Alexander Troyanovsky', at: [0.3, 1.5], face: 150, coat: '#5a5a6a', vest: '#8a8a7a', moustache: true,
    ...
    },
    {
      ...
      scene: {
        ...
        camera: { pos: [6, 3.6, 7], look: [0, 1, -0.5] },
        props: [
        ...
        figures: [
          { id: 'hitler', model: 'male-d', pose: 'interact', name: 'Adolf Hitler', at: [-3.4, -0.7], face: 55, coat: '#4a4a48', hair: '#2a2016', moustache: 'small', held: 'brush', skin: '#e8c8a8',
          ...
          { id: 'neumann', model: 'male-f', hair: '#2a2016', name: 'Josef Neumann', at: [-1.5, 1.1], face: 0, pose: 'sit', coat: '#5a5040', hat: 'cap', capColor: '#3a3a3a',
          ...
          { id: 'lodger', model: 'male-b', pose: 'sit', name: 'Another lodger', at: [3.6, 0], face: 270, pose: 'sit', coat: '#6a6058', hat: 'cap', capColor: '#5a4a3a', held: 'paper',
    ...
    },
    {
      ...
      scene: {
        ...
        figures: [
          { id: 'tito', model: 'male-f', hair: '#2a2016', pose: 'both', name: 'Josip Broz', at: [-1.6, 1.8], face: 40, coat: '#3a4a6a', trousers: '#2a2a2a', hat: 'cap', capColor: '#2a2a2a', moustache: 'small',
          ...
          { id: 'foreman', model: 'male-d', hair: '#2a2016', pose: 'hold', name: 'The foreman', at: [-4.5, -2.9], face: 150, coat: '#4a4a4a', vest: '#7a7a6a', moustache: true, held: 'paper',
