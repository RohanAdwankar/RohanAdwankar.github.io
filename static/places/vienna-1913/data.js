  ...
  pins: [
    {
      ...
      scene: {
        ...
        figures: [
          { id: 'trotsky', name: 'Leon Trotsky', at: [-2, 0.8], face: 0, pose: 'sit', coat: '#2e2e34', hair: '#2a2016', glasses: true, moustache: true, beard: '#2a2016',
          ...
          { id: 'altenberg', name: 'Peter Altenberg', at: [3.5, -1.4], face: 180, pose: 'sit', coat: '#8a7a66', hair: 'none', bald: true, moustache: true, skin: '#e8c8a8',
          ...
          { id: 'adler', name: 'Alfred Adler', at: [-4.5, -2.2], face: 0, pose: 'sit', coat: '#3a3f4a', vest: '#6a6a5a', moustache: true, glasses: true,
          ...
          { id: 'waiter', name: 'The Herr Ober', at: [0.5, 1.2], face: 200, coat: '#151515', vest: '#f4f0e6', hands: 'forward', held: 'paper',
    ...
    },
    {
      ...
      scene: {
        ...
        camera: { pos: [4.5, 3.4, 6], look: [-0.5, 1, -0.5] },
        props: [
          { type: 'rug', at: [0, 0], w: 6, d: 5, color: '#7a2f2f' },
          { type: 'couch', at: [-1.5, -1.5], rot: 0 }, { type: 'armchair', at: [-3.2, -2.2], rot: 60 },
        ...
        figures: [
          { id: 'freud', name: 'Sigmund Freud', at: [-3.2, -2.2], face: 60, pose: 'sit', coat: '#3a3a3a', vest: '#5a5a5a', hair: '#8a8a8a', beard: '#8a8a8a', glasses: true, skin: '#ddb090',
          ...
          { id: 'patient', name: 'A patient', at: [-1.2, -1.3], face: 90, pose: 'sit', coat: '#6a5a7a', hair: '#3a2a1a',
          ...
          { id: 'anna', name: 'Anna Freud', at: [2.0, -1.9], face: 180, pose: 'sit', coat: '#8a6a5a', hair: '#3a2a1a', held: 'paper',
    ...
    },
    {
      ...
      scene: {
        ...
        camera: { pos: [7, 5, 10], look: [0, 1.4, -1] },
        props: [
        ...
        figures: [
          { id: 'schoenberg', name: 'Arnold Schoenberg', at: [0, -3.2], face: 180, coat: '#1a1a1a', vest: '#f4f0e6', hair: 'none', bald: true, held: 'baton', hands: 'raised',
          ...
          { id: 'berg', name: 'Alban Berg', at: [-5.5, 0.2], face: 90, coat: '#2a2a30', hair: '#2a2016',
          ...
          { id: 'webern', name: 'Anton Webern', at: [5.5, 0.2], face: 270, coat: '#2a2a30', glasses: true, hair: '#4a3a2a',
          ...
          { id: 'buschbeck', name: 'Erhard Buschbeck', at: [0, 3.6], face: 180, coat: '#3a3a44', hands: 'raised',
          ...
          { id: 'heckler', name: 'A heckler', at: [1.2, 3.8], face: 200, coat: '#5a4a3a', hat: 'bowler', hands: 'raised', moustache: true,
    ...
    },
    {
      ...
      scene: {
        ...
        figures: [
          { id: 'franzjoseph', name: 'Franz Joseph I', at: [-1.5, -1.6], face: 200, coat: '#3a5a8a', vest: '#f4f0e6', hair: '#d8d8d8', bald: true, beard: '#d8d8d8', moustache: true, skin: '#e8c0a0', hands: 'forward', held: 'paper',
          ...
          { id: 'adjutant', name: 'Adjutant on duty', at: [2.5, 1.0], face: 300, coat: '#2e4a2e', hat: 'military', moustache: true,
    ...
    },
    {
      ...
      scene: {
        ...
        props: [
          ...
          { type: 'armchair', at: [-3.2, 0.8], rot: 90 }, { type: 'armchair', at: [3.2, 0.8], rot: 270 },
          { type: 'chandelier', at: [0, 0.5] },
          { type: 'cabinet', at: [-5.0, 1.5], rot: 90 },
        ],
        figures: [
          { id: 'franzferdinand', name: 'Archduke Franz Ferdinand', at: [0, -1.7], face: 180, pose: 'sit', coat: '#2e4a2e', vest: '#c8a860', moustache: true, hair: '#4a3a2a', skin: '#e0b898',
          ...
          { id: 'sophie', name: 'Sophie, Duchess of Hohenberg', at: [3.2, 0.8], face: 270, pose: 'sit', coat: '#7a4a6a', hair: '#3a2a1a', shawl: '#c8b8d8',
          ...
          { id: 'brosch', name: 'Major Brosch', at: [-2.4, -2.6], face: 120, coat: '#2e4a2e', hat: 'military', moustache: true, held: 'paper', hands: 'forward',
    ...
    },
    {
      ...
      scene: {
        ...
        camera: { pos: [3.6, 2.8, 4.6], look: [0, 1, -0.5] },
        props: [
          { type: 'desk', at: [-1.2, -2.0] }, { type: 'chair', at: [-1.2, -1.2], rot: 180 },
          { type: 'bookshelf', at: [2.2, -2.6], w: 1.4 }, { type: 'chair', at: [1.5, -0.6], rot: 250 },
          { type: 'rug', at: [0, 0.5], w: 3, d: 2.5, color: '#5a4a5a' }, { type: 'lamp', at: [-2.8, 0.5] },
          { type: 'bunk', at: [2.6, 1.5], rot: 90 },
        ],
        figures: [
          { id: 'stalin', name: 'Joseph Stalin', at: [-1.2, -1.2], face: 180, pose: 'sit', coat: '#3a3a3a', hair: '#1a1a1a', moustache: true, skin: '#d8a888',
          ...
          { id: 'bukharin', name: 'Nikolai Bukharin', at: [1.5, -0.6], face: 250, pose: 'sit', coat: '#4a4a5a', hair: '#8a5a2a', beard: '#8a5a2a', glasses: true,
          ...
          { id: 'troyanovsky', name: 'Alexander Troyanovsky', at: [-2.4, 0.9], face: 120, coat: '#5a5a6a', vest: '#8a8a7a', moustache: true,
    ...
    },
    {
      ...
      scene: {
        ...
        props: [
          ...
          { type: 'easel', at: [-3.6, -2.4], rot: 40, paint: '#c8b088' },
          { type: 'bunk', at: [5.5, -2.5] }, { type: 'bunk', at: [-5.5, 2.5] }, { type: 'bunk', at: [5.5, 2.5] },
          { type: 'bookshelf', at: [1, -3.6], w: 2 },
        ],
        figures: [
          { id: 'hitler', name: 'Adolf Hitler', at: [-3.1, -1.8], face: 40, coat: '#4a4a48', hair: '#2a2016', moustache: 'small', held: 'brush', hands: 'forward', skin: '#e8c8a8',
          ...
          { id: 'neumann', name: 'Josef Neumann', at: [-1.5, 1.1], face: 0, pose: 'sit', coat: '#5a5040', hat: 'cap', capColor: '#3a3a3a',
          ...
          { id: 'lodger', name: 'Another lodger', at: [3.6, 0], face: 270, pose: 'sit', coat: '#6a6058', hat: 'cap', capColor: '#5a4a3a', held: 'paper',
    ...
    },
    {
      ...
      scene: {
        ...
        props: [
          { type: 'car', at: [0, 0], rot: 20 }, { type: 'car', at: [4.5, -2.5], rot: 90, color: '#6a2f2f' },
          { type: 'workbench', at: [-4.5, -3.8] }, { type: 'workbench', at: [-1.5, -4.0] },
          { type: 'column', at: [-6, -4] }, { type: 'column', at: [6, -4] },
          { type: 'lamp', at: [-5.5, 2.5] },
        ],
        figures: [
          { id: 'tito', name: 'Josip Broz', at: [-1.8, 1.4], face: 60, coat: '#3a4a6a', trousers: '#2a2a2a', hat: 'cap', capColor: '#2a2a2a', hands: 'forward', moustache: 'small',
          ...
          { id: 'foreman', name: 'The foreman', at: [-3.6, -2.8], face: 150, coat: '#4a4a4a', vest: '#7a7a6a', moustache: true, held: 'paper', hands: 'forward',
